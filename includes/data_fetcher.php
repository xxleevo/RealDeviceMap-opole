...
if ($config['ui']['table']['forceRaidCards'] || (!$config['ui']['table']['forceRaidCards'] && is_mobile())) {
    ...
    try {
        ...
        echo "<tr class='text-nowrap'>";
            ...
            echo "<th class='starts' onclick='sort_table(\"gym-table\",1)'>Raidstart</th>";
            echo "<th class='ends' onclick='sort_table(\"gym-table\",2)'>Raidende</th>";
            ...
            echo "<th class='gym' onclick='sort_table(\"gym-table\",6)'>Arena</th>";
            echo "<th class='city' onclick='sort_table(\"gym-table\",7)'>Stadt</th>";
            echo "<th class='team' onclick='sort_table(\"gym-table\",8)'>Team</th>";
            echo "<th class='ex' onclick='sort_table(\"gym-table\",9)'>Ex-Fähig</th>";
            echo "<th class='updated' onclick='sort_table(\"gym-table\",10)'>Aktualisiert</th>";
        echo "</tr>";
        echo "</thead>";
        echo "<tbody>";
